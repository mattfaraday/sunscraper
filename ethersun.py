...
## Failure scenario: This will cause the miner to pause if it's not able to get the current immersun stats
try:
  ...
  print("Communication error, sending pause anyway.\nComms error was:",e)
  lastbreath = requests.get("http://"+trexIP+":"+trexPort+"/control?pause=true")
  sys.ext(2)
else:
  ###DEBUGGING
  print("Mining = ", mining)
